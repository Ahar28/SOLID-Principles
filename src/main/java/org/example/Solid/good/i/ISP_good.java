...
public class ISP_good {
    ...
    public static void main(String[] args) {
        ...
        StringComparisionImpl stringComparision = new StringComparisionImpl();
        StringManipulationImpl stringManipulation = new StringManipulationImpl();
        StringTraversalImpl stringTraversal = new StringTraversalImpl();
        ReversalImpl reversal = new ReversalImpl();
        ...
        do {
            ...
            switch (choice) {
                case 1:
                    System.out.println("There are " + stringTraversal.CharacterCount(text1) + " characters in the text: " + "\n" + "\"" + text1 + "\"");
                    break;
                case 2:
                    System.out.println("The reversed String of "+text2+" is "+reversal.reversetheString(text2));
                    break;
                case 3:
                    scanner.nextLine();
                    System.out.print("Enter String 1 : ");
                    String userInput = scanner.nextLine();
                    if ( stringComparision.isPalindrome(userInput)==true) {
                    ...
                    break;
                case 4:
                    System.out.println("There are "+stringTraversal.wordCount(text1)+" number of words in the text");
                    break;
                case 5:
                    System.out.println("Capitalized String is "+"\""+stringManipulation.capitalizeWords(text1)+"\"");
                    break;
                case 6:
                    scanner.nextLine();
                    System.out.print("Enter String 1 : ");
                    ...
                    if ( stringComparision.isAnagram(userInput1, userInput2)==true) {
                    ...
                    break;
                case 7:
                    Map<Character, Integer> countCharacterFrequency = stringTraversal.charFreq(text1);
